...
<div class="main-content">
    ...
    <div class="main-content-inner">
        ...
        <div class="main-content-wrap">
            ...
            <div class="wg-box mb-5">
                <div class="gap22 cols">
                    <fieldset class="category">
                        <div class="body-title mb-10">Choose Product <span class="tf-color-1">*</span>
                        </div>
                        <div class="select">
                            <select class="" name="category_id" id="category_id">
                                <option>Choose Product</option>
                                @foreach ($products as $product)
                                <option value="{{$product->id}}">{{$product->name}}, {{$product->category->name}},
            ...
            <!-- form-add-product -->
            <div id="product-details-div" style="display: none">
                <form class="tf-section-2 form-add-product mt-5" method="POST" action="{{route('admin.sale.store')}}">
                    @csrf
                    <div class="wg-box">
                        @if (session('error'))
                        ...
                        <fieldset class="name">
                            ...
                            <input class="mb-10" type="text" placeholder="Enter product name" name="name" tabindex="0"
                                value="" aria-required="true" readonly disabled id="product_name">
                        </fieldset>

                        <fieldset class="name">
                            <div class="body-title mb-10">Slug<div>
                                    <input class="mb-10" type="text" placeholder="Enter product slug" name="slug"
                                        tabindex="0" value="" aria-required="true" readonly disabled id="product_slug">
                        </fieldset>
                        ...
                        <div class="gap22 cols">
                            <fieldset class="category">
                                ...
                                <input class="mb-10" type="text" placeholder="Category name" name="name" tabindex="0"
                                    value="" aria-required="true" readonly disabled id="product_category">
                            </fieldset>
                            <fieldset class="brand">
                                <div class="body-title mb-10">Brand</span>
                                </div>
                                <input class="mb-10" type="text" placeholder="Brand name" name="name" tabindex="0"
                                    value="" aria-required="true" readonly disabled id="product_brand">
                            </fieldset>
                        </div>
                        ...
                        <div class="cols gap22">
                            <fieldset class="name">
                                ...
                                <input class="mb-10" type="text" placeholder="Enter regular price" name="regular_price"
                                    tabindex="0" value="" aria-required="true" readonly id="product_regular_price">
                            </fieldset>
                        </div>
                    ...
                    <div class="wg-box">
                        <fieldset>
                            ...
                            <div class="upload-image flex-grow">
                                <div class="item" id="imgpreview" style="display:block">
                                    <img src="" class="effect8" alt="" id="product_image">
                                </div>
                            </div>
                        </fieldset>
                        ...
                        <div class="cols gap22">
                            <fieldset class="name">
                                ...
                                <input class="mb-10" type="text" placeholder="Enter SKU" name="SKU" tabindex="0"
                                    value="" aria-required="true" readonly disabled id="product_sku">
                            </fieldset>
                            <fieldset class="name">
                                <div class="body-title mb-10">Quantity</span>
                                </div>
                                <input class="mb-10" type="text" placeholder="Enter quantity" name="quantity"
                                    tabindex="0" value="" aria-required="true" readonly disabled id="product_quantity">
                            </fieldset>
                        </div>
                        ...
                        <div class="cols gap22">
                            <fieldset class="name">
                                ...
                                <input class="mb-10" type="text" placeholder="Enter quantity" name="quantity"
                                    tabindex="0" value="" aria-required="true" readonly disabled id="product_stock">
                            </fieldset>
                        </div>
                        <div class="cols gap22">
                            <fieldset class="name">
