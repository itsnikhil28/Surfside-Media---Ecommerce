            ...
            <div class="col-lg-10">
                <div class="page-content my-account__edit">
                    <div class="my-account__edit-form">
                        ...
                        @endif
                        <form name="account_edit_form" action="{{route('users.account-details-change')}}" method="POST" class="needs-validation" novalidate="">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <div class="form-floating my-3">
                                        <input type="text" class="form-control" placeholder="Mobile Number"
                                            name="phoneno" value="{{$user->phoneno}}" required="">
