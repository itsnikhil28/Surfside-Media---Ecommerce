            ...
            <div class="row row-cols-lg-5 row-cols-2">
                <div class="footer-column footer-store-info col-12 mb-4 mb-lg-0">
                    ...
                    <ul class="social-links list-unstyled d-flex flex-wrap mb-0">
                        <li>
                            <a href="javascript:void(0)" class="footer__social-link d-block">
                ...
                <div class="footer-column footer-menu mb-4 mb-lg-0">
                    ...
                    <ul class="sub-menu__list list-unstyled">
                        <li class="sub-menu__item">
                            <a href="/about" class="menu-link menu-link_us-s">About Us</a>
                        </li>
                        <li class="sub-menu__item">
                            <a href="javascript:void(0)" class="menu-link menu-link_us-s">Careers</a>
                        </li>
                        <li class="sub-menu__item">
                            <a href="/affiliate" class="menu-link menu-link_us-s">Affiliates</a>
                        </li>
                        {{-- <li class="sub-menu__item">
                            <a href="blog_list1.html" class="menu-link menu-link_us-s">Blog</a>
                        </li> --}}
                        <li class="sub-menu__item">
                            <a href="/contact" class="menu-link menu-link_us-s">Contact
                                Us</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="footer-column footer-menu mb-4 mb-lg-0">
                    ...
                    <ul class="sub-menu__list list-unstyled">
                        <li class="sub-menu__item">
                            <a href="/contact" class="menu-link menu-link_us-s">Customer
                                Service</a>
                        </li>
                        <li class="sub-menu__item">
                            <a href="{{route('users.account-details')}}" class="menu-link menu-link_us-s">My
                                Account</a>
                        </li>
                        <li class="sub-menu__item">
                            <a href="/store_location" class="menu-link menu-link_us-s">Find a
                                Store</a>
                        </li>
                        <li class="sub-menu__item">
                            <a href="/privacy-policy" class="menu-link menu-link_us-s">Legal &
                                Privacy</a>
                        </li>
                    ...
                    <ul class="sub-menu__list list-unstyled">
                        ...
                        <li class="sub-menu__item">
                            <form action="{{ route('shop.sort') }}" method="POST" id="categorysort-{{ $category->id }}">
                                ...
                                <a href="javascript:void(0)" class="menu-link menu-link_us-s py-1" onclick="document.getElementById('categorysort-{{ $category->id
                                    }}').submit();">
                                    {{ $category->name }}
                                </a>
                            </form>
